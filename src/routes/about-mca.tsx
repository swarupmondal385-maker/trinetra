...
export const Route = createFileRoute("/about-mca")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.mcamsv.com/about-mca" },
      ...
      { name: "twitter:title", content: "About MCA — MAKAUT Cultural Association" },
      { name: "twitter:description", content: "The MAKAUT Cultural Association, established 21 February 2025, is a 900+ member student community and the organiser of TRINETRA 2026." },
    ],
    links: [{ rel: "canonical", href: "https://www.mcamsv.com/about-mca" }],
  }),
  component: AboutMca,
});
