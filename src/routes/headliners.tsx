...
export const Route = createFileRoute("/headliners")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Artists & Highlights — DJ Koyel, The Morphine India | TRINETRA 2026" },
      { name: "twitter:description", content: "DJ Koyel on Day 1, The Morphine India on Day 2, plus Pathaks × Dhakis and the Influencers' Summit — the headline moments of TRINETRA 2026." },
    ],
