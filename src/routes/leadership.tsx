...
export const Route = createFileRoute("/leadership")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.mcamsv.com/leadership" },
      ...
      { name: "twitter:title", content: "Leadership — TRINETRA 2026 Organising Team" },
      { name: "twitter:description", content: "Faculty guidance, executive leadership, operations and sponsorship — the people accountable for delivering TRINETRA 2026." },
    ],
    links: [{ rel: "canonical", href: "https://www.mcamsv.com/leadership" }],
  }),
