...
export const Route = createFileRoute("/schedule")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.mcamsv.com/schedule" },
      ...
      { name: "twitter:title", content: "Event Schedule — TRINETRA 2026, 24–25 September" },
      { name: "twitter:description", content: "The full TRINETRA 2026 programme: Bodhan, Sammilan, Spandan, Garjan, Bicharan, Avahan, Darshan and Akalbodhan across two days." },
    ],
    links: [{ rel: "canonical", href: "https://www.mcamsv.com/schedule" }],
  }),
  component: Schedule,
});
