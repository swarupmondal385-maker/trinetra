...
export const Route = createFileRoute("/proof")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.mcamsv.com/proof" },
      ...
      { name: "twitter:title", content: "Proof Center — Claims, Sources and Documents" },
      { name: "twitter:description", content: "Every TRINETRA 2026 metric with its status and source, plus the downloadable media kit. Claims are easy; proof builds partnerships." },
    ],
    links: [{ rel: "canonical", href: "https://www.mcamsv.com/proof" }],
  }),
  component: Proof,
});
