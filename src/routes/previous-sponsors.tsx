...
export const Route = createFileRoute("/previous-sponsors")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.mcamsv.com/previous-sponsors" },
      ...
      { name: "twitter:title", content: "Previous Sponsors — Built Through Collaboration" },
      { name: "twitter:description", content: "Past brand associations of the MAKAUT Cultural Association. Logos are published only where an actual association exists." },
    ],
    links: [{ rel: "canonical", href: "https://www.mcamsv.com/previous-sponsors" }],
  }),
