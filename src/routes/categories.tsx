...
export const Route = createFileRoute("/categories")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.mcamsv.com/categories" },
      ...
      { name: "twitter:title", content: "Partnership Categories — TRINETRA 2026" },
      { name: "twitter:description", content: "Fifteen category partnerships for TRINETRA 2026 — telecom, beverage, media, style, prize, health, apparel, ticketing and more." },
    ],
    links: [{ rel: "canonical", href: "https://www.mcamsv.com/categories" }],
  }),
