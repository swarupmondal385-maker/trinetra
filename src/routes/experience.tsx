...
export const Route = createFileRoute("/experience")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.mcamsv.com/experience" },
      ...
      { name: "twitter:title", content: "TRINETRA 2026 Experience — Two Days, Twelve Worlds" },
      { name: "twitter:description", content: "Music, dance, culture, fashion, art, creators, competitions and brand activations — the TRINETRA 2026 experience, with a sponsor lens on every category." },
    ],
    links: [{ rel: "canonical", href: "https://www.mcamsv.com/experience" }],
  }),
