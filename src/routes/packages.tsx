...
export const Route = createFileRoute("/packages")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.mcamsv.com/packages" },
      ...
      { name: "twitter:title", content: "Sponsorship Packages — TRINETRA 2026 (₹3 Lakh to ₹15 Lakh+)" },
      { name: "twitter:description", content: "Title, Platinum, Gold and Silver sponsorship packages for TRINETRA 2026, with a full deliverable comparison matrix." },
    ],
    links: [{ rel: "canonical", href: "https://www.mcamsv.com/packages" }],
  }),
  component: Packages,
});
