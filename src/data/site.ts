...
export const packages: Package[] = [
  ...
  },
  {
    ...
    benefits: [
      "Constant advertisement on Digital Standee LED",
      "Sponsor hoardings in selected campus areas provided by sponsor",
      "Social media outreach",
      "Stalls",
      "Logo on certificate",
      "Selected promotional elements",
      "1 free VIP pass for the Fossils Show",
    ],
  },
  {
    ...
    price: "₹70,000+",
    benefits: [
      "Sponsor hoardings provided by sponsor in selected campus areas",
      "Social media outreach",
      "Logo on certificate",
      "Selected promotional elements",
    ],
...
export const comparisonRows: { row: string; tiers: Record<string, boolean> }[] = [
  { row: "Naming Rights", tiers: { Title: true, Platinum: false, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Digital Standee LED", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: true, Associate: false } },
  { row: "Main Stage LCD", tiers: { Title: true, Platinum: true, Gold: true, Silver: false, Bronze: false, Associate: false } },
  { row: "Stage Speech", tiers: { Title: true, Platinum: true, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Product Launch Sequence", tiers: { Title: true, Platinum: false, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Campus Hoardings", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: true, Associate: true } },
  { row: "Sponsor Gates", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: false, Associate: false } },
  { row: "Stalls", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: true, Associate: false } },
  { row: "Product Showcase", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: false, Associate: false } },
  { row: "Social Outreach", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: true, Associate: true } },
  { row: "Certificates", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: true, Associate: true } },
  { row: "Wristbands", tiers: { Title: true, Platinum: true, Gold: true, Silver: false, Bronze: false, Associate: false } },
  { row: "ID Cards", tiers: { Title: true, Platinum: true, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Trophies", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: false, Associate: false } },
  { row: "Merchandise", tiers: { Title: true, Platinum: false, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Show Tickets", tiers: { Title: true, Platinum: false, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "VIP Passes", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: true, Associate: false } },
  { row: "Selfie Zone", tiers: { Title: true, Platinum: true, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Autographed Merchandise", tiers: { Title: true, Platinum: true, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Live Feed Access", tiers: { Title: true, Platinum: false, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Pamphlet Distribution", tiers: { Title: true, Platinum: false, Gold: false, Silver: false, Bronze: false, Associate: false } },
  { row: "Event Mentions", tiers: { Title: true, Platinum: true, Gold: true, Silver: true, Bronze: true, Associate: true } },
];

export const tierKeys = ["Title", "Platinum", "Gold", "Silver", "Bronze", "Associate"];
...
export const activations = [
  ...
  { name: "Product Stall", best: ["Sampling", "Product trials", "Lead collection"], tier: "Bronze and above" },
