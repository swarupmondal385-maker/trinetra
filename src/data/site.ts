  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        time: "09:00 PM",
        description: "Prize distribution, gratitude to partners and the ceremonial close of TRINETRA 2026.",
        sponsorAngle: "Closing brand mention, trophy branding and partner felicitation on stage.",
      },
    ],
  },
];
...
export const experienceCategories = [
  { name: "Music", normal: "Live bands, campus artists, DJ Koyel and The Morphine India.", sponsor: "Stage sponsorship, LED advertisement, artist association." },
  { name: "Dance", normal: "Club showcases and student dance segments across both days.", sponsor: "Segment presenting rights and choreography-led branded content." },
  ...
  { name: "DJ Night", normal: "Day 1 closes with DJ Koyel on the main stage.", sponsor: "Peak-attendance visibility and immersive LED takeover." },
...
export const packages: Package[] = [
  {
    ...
    benefits: [
      ...
      "Product launch sequence of approximately 5 minutes before the Main Stage Concert",
      ...
      "50 free VIP passes",
      "5 DIAMOND seated passes for the Main Stage Concert",
      "Food and beverage coupons as described in the brochure",
      "5 artist-signed official T-shirts",
      "Exclusive promotional selfie zone",
      "Online live-feed access across both days, except the Main Stage Concert",
      "Advertisement pamphlet distribution among the Main Stage Concert audience",
      "Logo on official TRINETRA merchandise",
      "Logo on tickets of the Main Stage Concert",
  ...
  },
  {
    ...
    benefits: [
      ...
      "20 free VIP passes for the Main Stage Concert",
      "Food and beverage coupons as described in the brochure",
      "3 artist-signed official T-shirts",
      "Exclusive promotional selfie zone",
    ],
  },
  {
    ...
    benefits: [
      ...
      "Chief Guest invitation",
      "10 free VIP passes for the Main Stage Concert",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Chief Guest invitation",
      "5 VIP passes for the Main Stage Concert",
    ],
  },
];
